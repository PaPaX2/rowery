!(function () {
          ...
          void 0 !== r &&
            ...
            (v(e[i]) && v(a[i])
              ? a[i].__swiper__
                ...
                : b(e[i], a[i])
              : !v(e[i]) && v(a[i])
              ? ((e[i] = {}), a[i].__swiper__ ? (e[i] = a[i]) : b(e[i], a[i]))
              : (e[i] = a[i]));
        }
      }
    }
  ...
  class Z {
    constructor() {
      ...
      (r.__swiper__ = !0),
        (r.support = $()),
        (r.device = S({ userAgent: t.userAgent })),
        (r.browser = M()),
        (r.eventsListeners = {}),
  ...
  function de(e, t, s) {
    ...
    return (
      r.length ||
        ((r = h(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`)),
        i.append(r)),
      r
    );
  }
  const ce = [
    function (e) {
      ...
      a({
        ...
        i("init update resize", () => {
          s.params.virtual.enabled &&
            s.params.cssMode &&
            x(s.wrapperEl, "--swiper-virtual-size", `${s.virtualSize}px`);
        }),
        Object.assign(s.virtual, {
    ...
    function (e) {
      ...
      function c() {
        t.keyboard.enabled ||
          (h(l).on("keydown", d), (t.keyboard.enabled = !0));
      }
      function p() {
        t.keyboard.enabled &&
          (h(l).off("keydown", d), (t.keyboard.enabled = !1));
      }
    ...
    function (e) {
      ...
      function g(e) {
        return (
          ...
          !(
            ...
            f() - d < t.params.mousewheel.thresholdTime
          ) &&
          ((e.delta >= 6 && f() - d < 60) ||
            (e.direction < 0
      ...
      function v(e) {
        ...
        if (
          ("container" !== t.params.mousewheel.eventsTarget &&
            (n = h(t.params.mousewheel.eventsTarget)),
        ...
        if (r.forceToAxis)
          ...
          d =
            Math.abs(u.pixelX) > Math.abs(u.pixelY) ? -u.pixelX * p : -u.pixelY;
        if (0 === d) return !0;
        r.invert && (d = -d);
        ...
        if (
          ...
          const e = { time: f(), delta: Math.abs(d), direction: Math.sign(d) },
            a =
              o &&
              e.time < o.time + 500 &&
              e.delta <= o.delta &&
          ...
          if (!a) {
            ...
            let n = t.getTranslate() + d * r.sensitivity;
      ...
      function w(e) {
        let s = t.$el;
        "container" !== t.params.mousewheel.eventsTarget &&
          (s = h(t.params.mousewheel.eventsTarget)),
          s[e]("mouseenter", p),
          s[e]("mouseleave", u),
          s[e]("wheel", v);
      }
      ...
      s({
        ...
        a("click", (e, s) => {
          const { $nextEl: a, $prevEl: r } = t.navigation,
            n = s.target;
          if (t.params.navigation.hideOnClick && !h(n).is(r) && !h(n).is(a)) {
            if (
              t.pagination &&
              t.params.pagination &&
    ...
    function (e) {
      ...
      function c() {
        ...
        if (
          ("fraction" === s.type &&
            (r.find(ee(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            r.find(ee(s.totalClass)).text(s.formatFractionTotal(p))),
          "progressbar" === s.type)
        ) {
          let e;
      ...
      function p() {
        ...
        if ("bullets" === e.type) {
          ...
          a.html(r), (t.pagination.bullets = a.find(ee(e.bulletClass)));
        }
        "fraction" === e.type &&
          ((r = e.renderFraction
      ...
      function u() {
        ...
        0 !== s.length &&
          (t.params.uniqueNavElements &&
            ...
            ((s = t.$el.find(e.el)),
            s.length > 1 &&
              (s = s.filter((e) => h(e).parents(".swiper")[0] === t.el))),
      ...
      a("init", () => {
        ...
        a("click", (e, s) => {
          ...
          if (
            ...
            r.length > 0 &&
            !h(a).hasClass(t.params.pagination.bulletClass)
          ) {
            if (
              t.navigation &&
    ...
    function (e) {
      ...
      function v() {
        ...
        (s[0].style.width = ""),
          (s[0].style.height = ""),
          (d = t.isHorizontal() ? a[0].offsetWidth : a[0].offsetHeight),
          (c =
            t.size /
            (t.virtualSize +
      ...
      function C() {
        ...
        0 === r.length &&
          ((r = h(`<div class="${t.params.scrollbar.dragClass}"></div>`)),
          i.append(r)),
    ...
    function (e) {
      ...
      function b(e) {
        const s = t.support,
          a = t.params.zoom;
        if (((o = !1), (d = !1), !s.gestures)) {
          if (
            "touchstart" !== e.type ||
            ("touchstart" === e.type && e.targetTouches.length < 2)
          )
            return;
          (o = !0), (u.scaleStart = w(e));
        }
        (u.$slideEl && u.$slideEl.length) ||
        ((u.$slideEl = h(e.target).closest(`.${t.params.slideClass}`)),
      ...
      function E(e) {
        ...
        m.isMoved ||
          ...
          (m.startX = g(u.$imageWrapEl[0], "x") || 0),
          (m.startY = g(u.$imageWrapEl[0], "y") || 0),
      ...
      function C(e) {
        ...
        if (
          ...
          return;
        let i, r, l, o, d, p, f, g, v, w, b, x, y, E, T, C, $, S;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
          ...
          e
            ? (($ = u.$slideEl[0].offsetWidth),
              ...
              (l = u.$slideEl.offset().left + n.scrollX),
              (o = u.$slideEl.offset().top + n.scrollY),
              (d = l + $ / 2 - i),
              (p = o + S / 2 - r),
    ...
    function (e) {
      ...
      function d() {
        ...
        function p(e) {
          return r ? h(e).attr("data-swiper-slide-index") : h(e).index();
        }
        if (
          ("auto" === d && (d = 0), l || (l = !0), t.params.watchSlidesProgress)
        )
          e.children(`.${s.slideVisibleClass}`).each((e) => {
            o(r ? h(e).attr("data-swiper-slide-index") : h(e).index());
          });
        else if (d > 1) for (let e = i; e < i + d; e += 1) c(e) && o(e);
        else o(i);
        if (n.loadPrevNext)
          if (d > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            const e = n.loadPrevNextAmount,
              t = d,
              s = Math.min(i + t + Math.max(e, t), a.length),
              r = Math.max(i - Math.max(t, e), 0);
            for (let e = i + d; e < s; e += 1) c(e) && o(e);
      ...
      function c() {
        ...
        const s = t.params.lazy.scrollingElement
            ? h(t.params.lazy.scrollingElement)
            : h(e),
          a = s[0] === e,
    ...
    function (e) {
      ...
      function m(e) {
        ...
        t.navigation &&
          ...
          t.pagination &&
            a.is(ee(t.params.pagination.bulletClass)) &&
            a[0].click();
      }
      function f() {
        return (
      ...
      n("init", () => {
        t.params.hashNavigation.enabled &&
          (() => {
            ...
            t.params.hashNavigation.watchState && h(d).on("hashchange", c);
          })();
      }),
        n("destroy", () => {
          t.params.hashNavigation.enabled &&
            t.params.hashNavigation.watchState &&
            h(d).off("hashchange", c);
        }),
    ...
    function (e) {
      ...
      function n() {
        ...
        const s = e.clickedIndex,
          a = e.clickedSlide;
        if (a && h(a).hasClass(t.params.thumbs.slideThumbActiveClass)) return;
        if (null == s) return;
        let i;
        if (
          ((i = e.params.loop
        ...
        ne({
          ...
          setTransition: (e) => {
            ...
            (s ? t.slides.find(s) : t.slides).transition(e),
              oe({ swiper: t, duration: e, transformEl: s, allSlides: !0 });
          },
          overwriteParams: () => ({
            slidesPerView: 1,
            slidesPerGroup: 1,
            ...
            d.shadow &&
              (c
                ? ((u = s.find(".swiper-cube-shadow")),
                  0 === u.length &&
                    ((u = h('<div class="swiper-cube-shadow"></div>')),
                    s.append(u)),
                  u.css({ height: `${i}px` }))
        ...
        ne({
          ...
          setTranslate: () => {
            ...
            for (let i = 0; i < e.length; i += 1) {
              ...
              if (
                ...
                0 === e.length &&
                  (e = de(a, r, t.isHorizontal() ? "left" : "top")),
                  0 === s.length &&
                    (s = de(a, r, t.isHorizontal() ? "right" : "bottom")),
          ...
          setTransition: (e) => {
            ...
            (s ? t.slides.find(s) : t.slides)
              ...
              .transition(e),
              oe({ swiper: t, duration: e, transformEl: s });
          },
          perspective: () => !0,
          overwriteParams: () => ({
            slidesPerView: 1,
              ...
              if (
                ...
                let e = n
                  ...
                  s = n
                    ? t.find(".swiper-slide-shadow-right")
                    : t.find(".swiper-slide-shadow-bottom");
                0 === e.length && (e = de(r, t, n ? "left" : "top")),
                  0 === s.length && (s = de(r, t, n ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((m && f.shadow) || !m) {
              ...
              if ((0 === e.length && f.shadow && (e = de(r, a)), e.length)) {
  ...
  new J(".slider--menu", {
    ...
    loop: !0,
    pagination: { el: ".swiper-pagination-menu" },
  }),
    new J(".slider--main", {
      autoplay: { delay: 4500 },
      disableOnInteraction: !1,
    ...
    new J(".slider--products", {
      autoplay: { delay: 4e3 },
      breakpoints: {
        320: { slidesPerView: 1, spaceBetween: 40 },
        769: { slidesPerView: 2, spaceBetween: 10, slidesPerGroup: 2 },
        1e3: { slidesPerView: 3, spaceBetween: 40, slidesPerGroup: 3 },
      },
      loop: !0,
      navigation: {
  ...
  var pe = document.querySelector(".section--menu");
  document.querySelectorAll(".menuJS").forEach(function (e) {
    e.addEventListener("click", function (e) {
      e.preventDefault, pe.classList.toggle("active");
    });
  });
})();
